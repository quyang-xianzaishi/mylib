...
public class SideBarView extends View{
    ...
    private final int defaultNorTextColor = Color.parseColor("#ff171C61");
    private final int defaultPressTextColor = Color.parseColor("#ffea5412");
    ...
    private void init() {
        ...
        //paint.setTextSize( (float)DensityUtil.px2dip(mContext,25));
