...
import com.example.administrator.lubanone.activity.message.MomentsActivity;
import com.example.administrator.lubanone.adapter.message.viewholder.CircleViewHolder;
import com.example.administrator.lubanone.adapter.message.viewholder.ImageViewHolder;
import com.example.administrator.lubanone.adapter.message.viewholder.URLViewHolder;
import com.example.administrator.lubanone.adapter.message.viewholder.VideoViewHolder;
import com.example.administrator.lubanone.bean.message.ActionItem;
...
import com.example.administrator.lubanone.utils.DatasUtil;
import com.example.administrator.lubanone.utils.UrlUtils;
...
import com.example.administrator.lubanone.widgets.ExpandTextView.ExpandStatusListener;
import com.example.administrator.lubanone.widgets.MultiImageView;
import com.example.administrator.lubanone.widgets.PraiseListView.OnItemClickListener;
import com.example.administrator.lubanone.widgets.SnsPopupWindow;
import com.example.administrator.lubanone.widgets.dialog.CommentDialog;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        if(getItemViewType(position)==TYPE_HEAD){
            ...
            if(!TextUtils.isEmpty(content)){
                ...
                holder.contentTv.setExpandStatusListener(new ExpandStatusListener() {
                    @Override
            ...
            if(hasFavort || hasComment){
                if(hasFavort){//处理点赞列表
                    holder.praiseListView.setOnItemClickListener(new OnItemClickListener() {
                        @Override
