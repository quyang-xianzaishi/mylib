...
public class PlatformDataFragment extends BaseFragment {
  ...
  private final static String TAG = "PlatformDataFragment";
  ...
  public View initView() {
    ...
    adapter = new TrainCenterCommonAdapter(trainDatas, mActivity, true);
  ...
  private void getData(final PullToRefreshLayout refreshLayout) {
    Subscriber subscriber = new MySubscriber<TrainDataModel>(getActivity()) {
      ...
      public void onError(Throwable e) {
        ...
        HouLog.d(TAG, "平台培训资料onError " + e.toString());
      }
    ...
    HouLog.d(TAG + "平台培训资料参数:", params.toString());
