...
public class FragmentCustomer extends BaseFragment implements OnClickListener {
  ...
  private ListCustomerSuccessFragment successFragment;
  private ListCustomerFeedbackFragment feadbackFragment;
  ...
  public View initView() {
    ...
    fragmentTitle.setText(getInfo(R.string.us_customer_title));

    successFragment = new ListCustomerSuccessFragment();
    feadbackFragment = new ListCustomerFeedbackFragment();
    fragments = new ArrayList<>();
    fm = getChildFragmentManager();
    fragments.add(successFragment);
    fragments.add(feadbackFragment);
    pagerTitles = new String[]{getInfo(R.string.us_customer_success),
        getInfo(R.string.us_customer_feed_back)};
