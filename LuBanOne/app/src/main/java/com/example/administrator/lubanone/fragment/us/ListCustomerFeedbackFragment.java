...
public class ListCustomerFeedbackFragment extends BaseFragment {
  ...
  private void getDataRetrofit(final PullToRefreshLayout refreshLayout) {
    ...
    map.put("if_type", "feedback");
    map.put("page", String.valueOf(pageNo));
    Log.d("客户反馈请求参数", map.toString());
