...
public class DetailsFundBeCustomerFragment extends BaseFragment {

  private WebView mWebView;

  @Override
  public View initView() {
    View view = mInflater.inflate(R.layout.fragment_us_fund_be_customer, null);
    mWebView = (WebView) view.findViewById(R.id.us_fund_be_customer_webview);
    return view;
  }
  ...
  private void getDataRetrofit() {
    Subscriber getDataByPost = new MySubscriber<UsIntroduceBean>(getActivity()) {
      ...
      public void onError(Throwable e) {
        super.onError(e);
        HouLog.d("基金成为客户error", e.toString());
      ...
      public void onNext(UsIntroduceBean usIntroduceBean) {
        if (null == usIntroduceBean) {
          HouLog.d("基金成为客户result", "usIntroduceBean == null");
        } else if (null != usIntroduceBean) {
          HouLog.d("基金成为客户result", usIntroduceBean.getUrl());
    ...
    map.put("if_id", "6");
    HouLog.d("基金成为客户请求参数", map.toString());
