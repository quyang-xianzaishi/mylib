...
import com.example.administrator.lubanone.spannable.CircleMovementMethod;
import com.example.administrator.lubanone.spannable.SpannableClickable;
    ...
    private SpannableString setClickableSpan(final String textStr, final String id) {
        ...
        subjectSpanText.setSpan(new SpannableClickable(itemColor){
                                    ...
                                    public void onClick(View widget) {
                                        Toast.makeText(
                                            MyApplication.getContext(), textStr + " &id = " + id, Toast.LENGTH_LONG).show();
                                    }
