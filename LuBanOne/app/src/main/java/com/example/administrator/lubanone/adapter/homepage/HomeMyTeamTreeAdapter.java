 ...
 */
public class HomeMyTeamTreeAdapter extends BaseAdapter implements OnClickListener {
  ...
  public HomeMyTeamTreeAdapter(Context context, ListView listView, LinkedList<Node> linkedList,View parent){
    inflater = LayoutInflater.from(context);
    this.mContext = context;
    this.parent = parent;
    nodeLinkedList = linkedList;
