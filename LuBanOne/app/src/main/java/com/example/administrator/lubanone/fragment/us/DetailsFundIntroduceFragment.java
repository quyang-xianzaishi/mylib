...
public class DetailsFundIntroduceFragment extends BaseFragment {

  private WebView mWebView;

  @Override
  public View initView() {
    View view = mInflater.inflate(R.layout.fragment_us_fund_introduce, null);
    mWebView = (WebView) view.findViewById(R.id.us_fund_introduce_webview);
    return view;
  }
  ...
  private void getDataRetrofit() {
    Subscriber getDataByPost = new MySubscriber<UsIntroduceBean>(getActivity()) {
      ...
      public void onNext(UsIntroduceBean usIntroduceBean) {
        if (null == usIntroduceBean) {
          HouLog.d("基金介绍result", "usIntroduceBean == null");
        } else if (null != usIntroduceBean) {
          HouLog.d("基金介绍result", usIntroduceBean.getUrl());
    ...
    map.put("if_id", "4");
    HouLog.d("基金介绍请求参数", map.toString());
