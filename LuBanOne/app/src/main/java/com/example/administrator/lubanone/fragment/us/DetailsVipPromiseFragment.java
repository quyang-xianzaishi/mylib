...
public class DetailsVipPromiseFragment extends BaseFragment {

  private WebView mWebView;

  @Override
  public View initView() {
    View view = mInflater.inflate(R.layout.fragment_us_vip_promise, null);
    mWebView = (WebView) view.findViewById(R.id.us_vip_promise_webview);
    return view;
  }
  ...
  private void getDataRetrofit() {
    Subscriber getDataByPost = new MySubscriber<UsIntroduceBean>(getActivity()) {
      ...
      public void onError(Throwable e) {
        super.onError(e);
        HouLog.d("vip承诺error", e.toString());
      ...
      public void onNext(UsIntroduceBean usIntroduceBean) {
        if (null == usIntroduceBean) {
          HouLog.d("vip承诺result", "usIntroduceBean == null");
        } else if (null != usIntroduceBean) {
          HouLog.d("vip承诺result", usIntroduceBean.getUrl());
    ...
    map.put("if_id", "3");
    HouLog.d("vip承诺请求参数", map.toString());
