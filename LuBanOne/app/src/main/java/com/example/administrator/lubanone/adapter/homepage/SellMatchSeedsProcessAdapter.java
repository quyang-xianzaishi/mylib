...
public class SellMatchSeedsProcessAdapter extends CustomAdapter<JsbzlistBean> {

  public SellMatchSeedsProcessAdapter(List<JsbzlistBean> list) {
  ...
  public void setData2Views(ViewHolder viewHolder, JsbzlistBean item, int position) {
    ...
    tvOrderTime.setText(StringUtil.getBufferString(mContext.getString(R.string.apply_time),
        DebugUtils.convert(item.getApplytime(), "")));

    tvOrderCount.setText(StringUtil.getBufferString(mContext.getString(R.string.seed_count),
