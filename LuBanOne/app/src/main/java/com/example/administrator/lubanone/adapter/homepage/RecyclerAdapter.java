...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  public RecyclerAdapter(List<BuylistBean> buylist, Context context,
  ...
  public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
    ...
    if (holder instanceof MyViewHolder) {
      ...
      StringUtil
          .setTextSize(DebugUtils.convert(buylistBean.getSeedcount(), "0") + mContext
              .getString(R.string.pcs), myViewHolder.tv_digital_left, 22, 10);
