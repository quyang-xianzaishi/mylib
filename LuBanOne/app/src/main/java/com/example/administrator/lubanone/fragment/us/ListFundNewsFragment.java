...
public class ListFundNewsFragment extends BaseFragment {
  ...
  private void getDataRetrofit(final PullToRefreshLayout refreshLayout) {
    ...
    map.put("if_type", "news");
    map.put("page", String.valueOf(pageNo));
    HouLog.d("基金新闻请求参数", map.toString());
