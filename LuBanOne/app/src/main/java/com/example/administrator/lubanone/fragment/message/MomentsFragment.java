...
public class MomentsFragment extends Fragment implements OnClickListener,CircleContract.View,
    ...
    private void initView(){
        back = (TextView) getActivity().findViewById(R.id.activity_back);
        shoot = (TextView) getActivity().findViewById(R.id.shoot_img);
        title =(LinearLayout) getActivity().findViewById(R.id.activity_moments_title);

        back.setOnClickListener(this);
        shoot.setOnClickListener(this);

        recyclerView = (SuperRecyclerView) getActivity().findViewById(R.id.recyclerView);
        ...
        editText = (EditText) getActivity().findViewById(R.id.circleEt);
        sendIv = (ImageView) getActivity().findViewById(R.id.sendIv);
    ...
    public void update2DeleteCircle(String circleId) {
        Toast.makeText(getActivity(), "我要删除这条动态啦。。。。。。。。", Toast.LENGTH_LONG).show();
    ...
    public void update2AddFavorite(int circlePosition, FavortItem addItem) {
        Toast.makeText(getActivity(), "我要点赞啦。。。。。。。。。。", Toast.LENGTH_LONG).show();
        if (addItem != null) {
    ...
    public void update2DeleteFavort(int circlePosition, String favortId) {
        Toast.makeText(getActivity(), "我要取消点赞啦。。。。。。。。。。。。。。。", Toast.LENGTH_LONG).show();
        CircleItem item = (CircleItem) circleAdapter.getDatas().get(circlePosition);
    ...
    public void update2AddComment(int circlePosition, CommentItem addItem) {
        Toast.makeText(getActivity(), "我要评论啦。。。。。。。。", Toast.LENGTH_LONG).show();
        if (addItem != null) {
            CircleItem item = (CircleItem) circleAdapter.getDatas().get(circlePosition);
    ...
    public void update2DeleteComment(int circlePosition, String commentId) {
        Toast.makeText(getActivity(), "我要删除评论啦。。。。。。。。", Toast.LENGTH_LONG).show();
        CircleItem item = (CircleItem) circleAdapter.getDatas().get(circlePosition);
    ...
    private void setViewTreeObserver() {
        bodyLayout = (RelativeLayout) getActivity().findViewById(R.id.bodyLayout);
