...
public class ProcessSellConfirmAdapterNew extends CustomAdapter<GConfirmlistBean> {
  ...
  public ProcessSellConfirmAdapterNew(Context context, List<GConfirmlistBean> list,
