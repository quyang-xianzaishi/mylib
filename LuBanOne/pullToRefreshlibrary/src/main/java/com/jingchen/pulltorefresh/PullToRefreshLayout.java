...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    public void refreshFinish(int refreshResult) {
        ...
        if (null == customRefreshView && refreshingView != null ) {
        ...
        switch (refreshResult) {
            case SUCCEED:
                // 刷新成功
                if (null == customRefreshView && null != refreshStateImageView && null != refreshStateTextView) {
...
//                Log.d(TAG, "onPull_loading: " + currentFrame);
