...
public class RecyclerWrapAdapterPull extends RecyclerView.Adapter implements WrapperAdapterPull
{
    ...
    public RecyclerWrapAdapterPull(ArrayList<View> mHeaderViews, ArrayList<View> mFootViews, RecyclerView.Adapter mAdapter)
    {
